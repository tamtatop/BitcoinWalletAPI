...
def setup_admin_and_transaction_repository(wallet_repository: IWalletRepository) -> IAdminAndTransactionRepository:
...
def setup() -> FastAPI:
    ...
    transaction_and_admin_repository = setup_admin_and_transaction_repository(wallet_repository)
