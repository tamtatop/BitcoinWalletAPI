...
from app.core.admin.interactor import AdminError, AdminInteractor, GetStatisticsRequest, GetStatisticsResponse, \
    IAdminInteractor, IAdminRepository
...
from app.core.transaction.interactor import GetTransactionsRequest, GetTransactionsResponse, ITransactionInteractor, \
    ITransactionRepository, MakeTransactionRequest, MakeTransactionResponse, TransactionError, TransactionInteractor

from app.core.user.interactor import IUserInteractor, IUserRepository, UserCreatedResponse, UserInteractor, \
...
class WalletService:
    ...
    def create(cls,
        ...
        return cls(
            ...
            WalletInteractor(wallet_repository, user_repository, BlockChainTickerCurrencyConverter(), generate_new_unique_key),
            TransactionInteractor(transaction_repository, user_repository, wallet_repository, FeeCalculator()),
